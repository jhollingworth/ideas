...
namespace Ideas.Web.Controllers
{
    public class RouteRegistrar
    {
        public static void RegisterRoutesTo(RouteCollection routes)
        {
            ...
            //routes.CreateArea("Organization/Department", "Ideas.Web.Controllers.Organization.Department",
            ...
            //);
            //routes.CreateArea("Organization", "Ideas.Web.Controllers.Organization",
            ...
            routes.CreateArea("Root", "Ideas.Web.Controllers",
